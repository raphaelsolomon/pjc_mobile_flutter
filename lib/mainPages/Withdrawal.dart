...
class WithDrawal extends StatelessWidget {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Provider.of<Controller>(context, listen: true).isLoading
                            ...
                            : MaterialButton(
                                onPressed: () => validateAmount(context),
                                height: 40.0,
  ...
  void validateAmount(context) {
    if (_amountController.text.isNotEmpty &&
        _amountController.text == "NGN 0.00") {
      return Get.snackbar("Error", "Enter amount to withdraw",
          colorText: Colors.white, backgroundColor: Color(0xff0272BA));
    }

    int _amount = _amountController.numberValue.toInt();
    Provider.of<Controller>(context, listen: false).withDrawal(_amount);
  }
