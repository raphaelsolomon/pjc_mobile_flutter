...
class EstateDetails extends StatelessWidget {
  final EstateModel estateData;
  EstateDetails(this.estateData);
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...List.generate(
                              10,
                              (index) => estateData.location == 'Negotiable'
                                  ? _imagesCarViews()
                                  : _imagesView())
                        ],
                      ),
  ...
  Widget _imagesView() => Padding(
        padding: const EdgeInsets.symmetric(horizontal: 5.0),
        child: ClipRRect(
          borderRadius: BorderRadius.circular(5.0),
          child: Image.network(
            'https://miro.medium.com/max/10816/1*eO3CIaFBe7LMRePApDwSYA.jpeg',
            width: 90.0,
            height: 90.0,
            fit: BoxFit.cover,
          ),
